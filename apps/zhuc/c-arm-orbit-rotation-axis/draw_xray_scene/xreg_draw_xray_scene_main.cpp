...
int main(int argc, char* argv[])
{
  if (false) {
    argv[1] = "-v";
    argv[2] = "-i";
    argv[3] = "--mesh-color-bone";
    argv[4] = "--draw-origin";
    argv[5] = R"(D:\data\xreg\c-arm-orbit-rotation-axis\tmp\all_pd.h5)";
    argv[6] = R"(D:\tmp\xreg_output\pelvis_mesh.h5)";
    argv[7] = "-";
  ...
  if (true) {
    ...
    argv[2] = "-i";
    argv[3] = "--mesh-color-bone";
    argv[4] = R"(D:\data\xreg\c-arm-orbit-rotation-axis\tmp\57_1_pd.h5)";
    argv[5] = R"(D:\tmp\xreg_output\pelvis_mesh.h5)";
    argv[6] = R"(D:\data\xreg\c-arm-orbit-rotation-axis\tmp\regi_57.h5)";
