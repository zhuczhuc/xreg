...
int main(int argc, char* argv[])
{
  if (true) {
    argv[1] = "-v";
    argv[2] = R"(D:\data\xreg\c-arm-orbit-rotation-axis\saw_bone_00_FC18_crop-label.nii.gz)";
    argv[3] = R"(D:\tmp\xreg_output\pelvis_mesh.h5)";
