...
int main(int argc, char* argv[])
{
  if (true) {
    argv[1] = "-v";
    argv[2] = "-s";
    argv[3] = R"(D:\data\xreg\c-arm-orbit-rotation-axis\saw_bone_00_FC18_crop-label.nii.gz)";
    argv[4] = R"(D:\tmp\xreg_output\saw_bone_01_FC18_crop.nii.gz)";
    argv[5] = R"(D:\data\xreg\c-arm-orbit-rotation-axis\ct_lands.fcsv)";
    argv[6] = R"(D:\tmp\xreg_output\57_1_pd.h5)";
    argv[7] = R"(D:\tmp\xreg_output\regi_57.h5)";
    argv[8] = R"(D:\tmp\xreg_output\regi_debug_57.h5)";
